...
const getCategoryData = (categoryName: string) => {
  ...
  const categoryDescriptions: Record<string, string> = {
    ...
    'гостиная': 'Проектируем и изготавливаем эргономичную мебель для гостиной, которая становится центром вашего дома. Наши решения сочетают комфорт, стиль и функциональность.',
    ...
    'детская': 'Мы создаем решения для комфорта, здоровья и развития ваших детей. Наша мебель для детской комнаты безопасна, функциональна и способствует гармоничному развитию ребенка.',
    'спальня': 'Создаем уютные и функциональные интерьеры для спальни, где каждая деталь продумана для вашего комфортного отдыха и релаксации.',
    'гардеробная': 'Проектируем системы хранения, которые помогают организовать пространство и сделать вашу жизнь более упорядоченной. Гардеробные на заказ максимально используют доступное пространство.',
    ...
    'ванная комната': 'Создаем мебель для ванной комнаты, устойчивую к влаге и долговечную. Наши решения помогают организовать пространство даже в небольших помещениях.',
    ...
    'мебель для отелей': 'Разрабатываем комплексные решения для гостиничного бизнеса, создавая уникальную атмосферу и обеспечивая комфорт гостей.',
  ...
  // Грамматически правильные заголовки и предложения
  const titleFormats: Record<string, { title: string, question: string }> = {
    'прихожая': { 
      title: 'Мебель в прихожую на заказ по индивидуальным размерам', 
      question: 'Нужна мебель в прихожую?' 
    },
    'гостиная': { 
      title: 'Мебель для гостиной на заказ по индивидуальным размерам', 
      question: 'Нужна мебель для гостиной?' 
    },
    'кухня': { 
  ...
  const categoryImages: Record<string, string> = {
    ...
    'гардеробная': 'https://i.postimg.cc/CMf9Tjxs/k3u1-F9-Odg0.png',
    'шкафы': 'https://i.postimg.cc/W457YmfV/1b-F5-JIOCs-V-1.png',
    'ванная комната': 'https://i.postimg.cc/G3kT55GP/0-T2p-Iwn3-Cf.png',
    'мягкая мебель': 'https://i.postimg.cc/fyPz8PYd/AErw-XCs-HOn.png',
    'мебель для отелей': 'https://i.postimg.cc/x8BWBV8K/4-KM0-OH6-Myn.png',
  ...
  const titleData = titleFormats[categoryKey] || { 
    title: `${categoryName.charAt(0).toUpperCase() + categoryName.slice(1)} на заказ по индивидуальным размерам`, 
    question: `Нужна ${categoryName.toLowerCase()}?`
  };
  
  return {
    name: categoryName.charAt(0).toUpperCase() + categoryName.slice(1),
    description: categoryDescriptions[categoryKey] || 'Мебель на заказ по индивидуальным размерам',
    image: categoryImages[categoryKey] || 'https://i.postimg.cc/DyXGPN0K/bfl8-HSy-URY.png',
    ...
    titleFormatted: titleData.title,
    questionFormatted: titleData.question
  };
};
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div className="lg:col-span-7 order-2 lg:order-1">
              <div className="grid grid-cols-1 gap-6">
                {/* Block 1: Title and Description - Updated with formatted title */}
                <div className="bg-[#F5F5F5] rounded-xl p-8">
                  <h1 className="text-4xl font-playfair mb-6">
                    {categoryData.titleFormatted}
                  </h1>
                ...
                {/* Block 2: CTA Question - Updated with formatted question */}
                <div className="bg-[#F5F5F5] rounded-xl p-8 flex flex-col justify-between">
                  <div className="mb-6">
                    <h2 className="text-3xl font-medium mb-4">
                      {categoryData.questionFormatted}
                    </h2>
                  </div>
                  <div>
                    <ContactFormDialog
                      ...
                      title={`Заказать ${category && category.toLowerCase()}`}
